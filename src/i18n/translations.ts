...
const en = {
  ...
  vocabulary: {
    title: 'Vocabulary', subtitle: 'Browse, search, and study 2000+ words with Vietnamese meanings.',
...
const vi = {
  ...
  vocabulary: {
    title: 'Từ vựng', subtitle: 'Duyệt, tìm kiếm và học hơn 2000 từ kèm nghĩa tiếng Việt.',
